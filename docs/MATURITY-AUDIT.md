...
| [#10 Build a real-world signed Omarchy package and lifecycle test corpus](https://github.com/SurreptitiousFabric/a-quo/issues/10) | Omarchy | **Design** (was Backlog) | Defined | The [owned corpus baseline](OMARCHY-CORPUS.md) freezes exact public commits for Omarchy Frame and Sonarchy as representative complex plugins and Plug & Prejudice as a separate recursion/integration subject, plus the ledger, derivative-signing, hostile-package, and clean-system evidence rules. This A Quo corpus owns package, proof, structure, subject-binding, policy, and lifecycle expectations; behavioural analyzer correctness belongs to Plug & Prejudice. A small ordinary third target, canonical packages/proofs/streams, normal increasing-version pairs, builder recipe, retained native-report fixtures, and clean-system results remain absent. |
