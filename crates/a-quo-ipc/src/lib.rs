...
pub use linux::{
    ...
    PeerCredentials, ReceivedSignRequest, ReceivedSignResponse, SealedArtifact, SealedProof,
    connect_consent_socket, connection_state, peer_credentials, receive_sign_request,
    receive_sign_response, seal_proof_bytes, send_sign_approved, send_sign_rejected,
    send_sign_request, snapshot_artifact,
};
pub use protocol::{
