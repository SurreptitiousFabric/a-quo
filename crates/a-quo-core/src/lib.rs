...
pub use recovery::{
    ...
    TerminalPersonaRevocationStatement, VerifiedPersonaContinuityTransition,
    VerifiedRecoveryAwareContinuityChain, VerifiedRecoveryPolicy, VerifiedRecoveryPolicyChain,
    VerifiedRecoveryTransition, VerifiedRecoveryTransitionReceipt,
    VerifiedTerminalPersonaRevocation, VerifiedTerminalPersonaRevocationReceipt,
