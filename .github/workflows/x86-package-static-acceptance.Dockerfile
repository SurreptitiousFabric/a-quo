...
LABEL org.opencontainers.image.title="A Quo reviewed x86_64 static package environment" \
      org.opencontainers.image.description="Architecture-matched input for reviewed static package verification" \
      org.opencontainers.image.source="https://github.com/SurreptitiousFabric/a-quo" \
      org.opencontainers.image.architecture="amd64" \
      org.opencontainers.image.a-quo-acceptance="static-policy-reviewed"
